...
srun --cpu-bind=none --container-name RaySpace \
     ...
     bash -c "source /sc/home/anton.hackl/conda3/etc/profile.d/conda.sh && conda activate spatial_benchmark && export PYTHONPATH=\$PYTHONPATH:. && python benchmarks/mesh_overlap/selectivity_test.py --approaches exact direct_estimation estimated_mem10 --timeout 1200"
