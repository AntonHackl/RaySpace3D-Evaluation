...
srun --cpu-bind=none --container-name RaySpace \
     ...
     bash -c "source /sc/home/anton.hackl/conda3/etc/profile.d/conda.sh && conda activate spatial_benchmark && export PYTHONPATH=\$PYTHONPATH:. && python benchmarks/mesh_overlap/run_mesh_complexity_benchmark.py --runs 3 --num-objects 100 --approaches direct_estimation --timeout 1200"
