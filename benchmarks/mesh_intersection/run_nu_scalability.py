...
def main():
    parser = argparse.ArgumentParser(description="Nu scalability benchmark for mesh intersection")
    ...
    run_layout = create_benchmark_run_layout(SCRIPT_DIR, "intersection_nu_scalability")
