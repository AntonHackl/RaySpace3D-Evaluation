...
#
# Usage:
#   ./spheres_benchmark.sh                          # Run all approaches
#   ./spheres_benchmark.sh cgal,raytracer           # Run only CGAL and Raytracer
#   ./spheres_benchmark.sh sql                      # Run only SQL
...
echo "========================================"
echo "Spheres Benchmark Configuration"
echo "========================================"
