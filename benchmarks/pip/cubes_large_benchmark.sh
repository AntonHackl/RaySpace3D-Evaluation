...
#
# Usage:
#   ./cubes_large_benchmark.sh                          # Run all approaches
#   ./cubes_large_benchmark.sh cgal,raytracer           # Run only CGAL and Raytracer
#   ./cubes_large_benchmark.sh sql                      # Run only SQL
...
echo "========================================"
echo "Cubes Large Benchmark Configuration"
echo "========================================"
